...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://imgur.com/btgcoat.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    BLOCK_CHAT: process.env.BLOCK_CHAT || '',
    ALWAYS_ONLINE: convertToBool(process.env.ALWAYS_ONLINE) || false,
    PLATFORM:isHeroku?"Heroku":isKoyeb?"Koyeb":"VPS",isHeroku,isKoyeb,isVPS,
    AUTOMUTE_MSG: process.env.AUTOMUTE_MSG || '_Group automuted!_\n_(edit AUTOMUTE_MSG)_',
    ANTI_SPAM: process.env.ANTI_SPAM || '94703768140-94703768140@g.us',
    ...
    BOT_INFO: process.env.BOT_INFO || 'PasinduLk;Skl11;0;https://i.imgur.com/btgcoat.jpeg;https://chat.whatsapp.com/BQh9C7IQJaQLZD2JXz0WxT',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "PasinduLk",
    BOT_NAME: process.env.BOT_NAME || 'PasinduLk',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢PasinduLkꫂ;PasinduLk bot;https://i.imgur.com/btgcoat.jpeg' : process.env.AUDIO_DATA,
